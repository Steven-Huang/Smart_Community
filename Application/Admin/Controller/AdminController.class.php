...
class AdminController extends CommonController {
	...
	//管理员对业主信息进行处理
	//管理员审核业主申请信息，审核通过（需要考虑权限问题）
	public function approve_users(){
	     
	}	

	//管理员审核业主申请信息，审核不通过（需要考虑权限问题）
	public function reject_users(){
	
	}
    
	//管理员删除用户信息（需要考虑权限问题，还有相关材料）
	public function delete_users(){
	     
	}
	//管理员对物业人员信息进行处理
	//管理员审核物业人员申请信息，审核通过（需要考虑权限问题）
	public function approve_mgrs(){
	
	}
	
	//管理员审核物业人员申请信息，审核不通过（需要考虑权限问题）
	public function reject_mgrs(){
	
	}
	
	//管理员删除物业人员信息（需要考虑权限问题，还有相关材料）
