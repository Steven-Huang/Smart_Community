...
class ArticleModel extends Model {
    ...
    protected $pk = 'aid';
    //定义字段信息
    protected $fileds = array('aid','acid','atitle','keyword','source','author','des','content','valid_time','create_time','create_id','status','operate_time','operate_id');
    //定义字段映射
	...
	protected $_validate = array(
	    array('aid','require','标题不可以为空'),
	    array('acid','require','标题不可以为空'),
