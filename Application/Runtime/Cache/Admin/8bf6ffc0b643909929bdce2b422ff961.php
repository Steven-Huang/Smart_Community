      ...
      <div class="menu_section">
        ...
        <ul class="nav side-menu">
          ...
          <li><a><i class="fa fa-edit"></i> 通知管理 <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu" style="display: none">
              <li><a href="<?php echo U('Admin/Article/index','category_id=1&article_status=1');?>">小区通知</a>
              </li>
              <li><a href="<?php echo U('Admin/Article/index','category_id=2&article_status=1');?>">政府公告</a>
              </li>
              <li><a href="<?php echo U('Admin/Article/index','category_id=3&article_status=1');?>">办事指南</a>
              </li>
...
<!-- /top navigation -->
  ...
  <script>
    ...
    function logout(){
      $.ajax({
        type: "post",
        url: "/smart_community/index.php/Admin/Notice/logout",
        data: {
          },
        dataType: "json",
	...
	<div class="right_col" role="main">
		<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<a class="btn btn-success" href="<?php echo U('Article/add/');?>"> 
					<i class="fa fa-plus"></i>发布通知
					</a>
				</div>
			<div class="x_panel">
