		...
		<div class="col-lg-10 col-md-10 col-xs-12"
			...
			<div class="row">
				<div class="col-lg-2 col-md-2 col-xs-2">
					<a class="btn blue" href="<?php echo U('Article/add/');?>"> <i
						class="fa fa-plus"></i>增加文章
					</a>
				</div>
			...
			<table class="table table-striped table-bordered table-hover ">
				...
				<tbody>
					<?php if(is_array($alist)): $i = 0; $__LIST__ = $alist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td><?php if(($vo['top']) == "0"): ?><a
								href="<?php echo U('Article/updatetop/','id='.$vo['aid']);?>"><i
								class="fa fa-check"></i> </a> <?php else: ?> <a
								href="<?php echo U('Article/deletetop/','id='.$vo['aid']);?>"><i
								class="fa fa fa-times"></i></a><?php endif; ?></td>
						<td><?php if(($vo['channlid']) == "1"): echo ($vo["channlid"]); ?><i
								class="fa fa-check"></i><?php endif; ?></td>
						<td><?php echo ($vo["sort"]); ?></td>
						<td><?php echo (date("Y-m-d",$vo["create_time"])); ?></td>
						<td><a href="<?php echo U('Article/edit/','id='.$vo['aid']);?>"><i
								class="fa fa-edit"></i> 修改</a> <a
							href="<?php echo U('Article/delete/','id='.$vo['aid']);?>"
							onClick="delcfm()"><i class="fa fa-trash-o"></i> 删除</a></td>

					</tr><?php endforeach; endif; else: echo "" ;endif; ?>
				</tbody>
			</table>
			<ul class="pagination"><?php echo ($page); ?>
			</ul>
		</div>
		<!-- col end -->
	</div>
