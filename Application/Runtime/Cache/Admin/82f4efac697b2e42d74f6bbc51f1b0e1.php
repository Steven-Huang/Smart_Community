...
<!-- /top navigation -->
  ...
  <script>
    ...
    function logout(){
      $.ajax({
        type: "post",
        url: "/smart_community/index.php/Admin/Admin/logout",
        data: {
          },
        dataType: "json",
			        ...
			        <div class="col-md-12 col-sm-12 col-xs-12">
			          <div class="x_panel">
			              ...
			              <form class="form-horizontal form-label-left" id="register_form">
			                ...
			                <div class="item form-group">
			                  ...
			                  <div class="col-md-6 col-sm-6 col-xs-9">
			                    <input id="admin_nick_name" name="admin_nick_name" class="form-control col-md-7 col-xs-12" maxlength="10" placeholder="" required="required" type="text">
			                  </div>
			                </div>
			                <div class="item form-group">
			                  ...
			                  <div class="col-md-6 col-sm-6 col-xs-9">
			                    <input id="admin_true_name" name="admin_true_name" class="form-control col-md-7 col-xs-12" maxlength="10" placeholder="" required="required" type="text">
			                  </div>
			                </div>
			                <div class="item form-group">
			            ...
			            <div class="item form-group">
			              ...
			              <div class="col-md-6 col-sm-6 col-xs-9">
			                <input id="admin_id_card_num" name="admin_id_card_num" class="form-control col-md-7 col-xs-12" maxlength="18" placeholder="" required="required" type="text">
			              </div>
			            </div>                                                                        
			            <div class="item form-group">
    ...
    $('.multi.required')
     ...
     $('form').submit(function(e) {
        ...
        if (submit){
	    	$.ajax({
	            type: "post",
	            url: "/smart_community/index.php/Admin/Admin/do_add",
	            data: {
