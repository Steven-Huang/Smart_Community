									...
									$("#tab1")
											.append(
													"<tr><td>U"
															...
															+ "<?php echo U('Admin/Users/edit" + array + "');?>\"><i class=\"fa fa-pencil\"></i>更新</a>"
															+ "<a class=\"btn btn-danger btn-xs\" href=\""
															+ "<?php echo U('Admin/Admin/del_users" + array + "');?>\"><i class=\"fa fa-trash\"></i>删除</a></td>"
															+ "</tr>");
								}
