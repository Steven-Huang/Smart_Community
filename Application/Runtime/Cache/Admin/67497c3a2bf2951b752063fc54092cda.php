		...
		<div class="col-md-12 col-sm-12 col-xs-12">
        	<div class="x_panel">
                <ul id="myTab" class="nav nav-tabs " role="tablist">
                  <li role="presentation" class="active"><a href="#tab_content1" role="tab" id="approved-tab" data-toggle="tab" aria-expanded="true">业主（已审批）</a>
                  </li>
                  <li role="presentation" class=""><a href="#tab_content2" role="tab" id="pending-tab" data-toggle="tab" aria-expanded="false">业主（待审批）</a>
                  </li>
                </ul>
