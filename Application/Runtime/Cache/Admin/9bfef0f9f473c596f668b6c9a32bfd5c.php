	...
	<div class="right_col" role="main">
		<div class="col-lg-10 col-md-10 col-xs-12"
			...
			<div class="col-lg-2 col-md-2 col-xs-2">
				<a class="btn btn-success" href="<?php echo U('Category/add/');?>"> <i
			...
			<div class="x_panel">
				...
				<ul class="nav nav-tabs ">
					<li class="active"><a href="<?php echo U('Category/index/');?>"><b>分类列表</b></a></li>
				...
				<table class="table table-striped table-bordered table-hover ">
					...
					<tbody>
						<?php if(is_array($clist)): $i = 0; $__LIST__ = $clist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td><a href="<?php echo U('Category/edit/','id='.$vo['acid']);?>"><i
									class="fa fa-edit"></i> 修改</a> <a
								href="<?php echo U('Category/delete/','id='.$vo['acid']);?>"
