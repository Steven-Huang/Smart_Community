	...
	<script type="text/javascript">
		window.onload = function() {
			$
					.ajax({
						type : "post",
						url : "/smart_community/admin.php/Feedback/indexPost",
						data : {
									...
									$("#tab1")
											.append(
													"<tr><td>"
															...
															+ "</td><td>"
															+ data['data']['data'][i]['operate_id']
															+ "</td><td>"
															+ data['data']['data'][i]['operate_time']
															+ "</td><td><a class=\"btn btn-info btn-xs\" href=\""
															+ "<?php echo U('Admin/Feedback/detail2" + array + "');?>\"><i class=\"fa fa-search-plus\"></i> 详情</a>"
															+ "</td>"
															+ "</tr>");
								}
