	...
	<div class="right_col" role="main">
		<div class="col-lg-10 col-md-10 col-xs-12"
			...
			<ul class="nav nav-tabs ">
				<li><a href="<?php echo U('Articlecate/index/');?>"><b>分类列表</b></a></li>
				<li class="active"><a href="<?php echo U('Articlecate/add/');?>"><b>增加分类</b></a></li>
			</ul>
			<p></P>
			<div class="row">
			...
			<form class="form-horizontal" role="form"
				...
				action="<?php echo U('Articlecate/addsave/');?>">
