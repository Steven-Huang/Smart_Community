			...
			<div class="x_panel">
				<ul id="myTab" class="nav nav-tabs " role="tablist">
					<li role="presentation" class="active"><a href="#tab_content1"
						...
						aria-expanded="true">物业人员（已审批）</a></li>
					<li role="presentation" class=""><a href="#tab_content2"
						role="tab" id="pending-tab" data-toggle="tab"
						aria-expanded="false">物业人员（待审批）</a></li>
				</ul>
	...
	<script type="text/javascript">
		window.onload = function() {
			$
					.ajax({
						type : "post",
						url : "/smart_community/admin.php/Mgrs/approved_mgrs",
						data : {
						...
						success : function(data) {
							if (data['code'] == 200) {
								...
								for (var i = 0; i < len; i++) {
									var array = "/role/mgrs/user_id/"
											+ data['data']['data'][i]['id'];
									$("#tab1")
											.append(
													"<tr><td>M"
															+ data['data']['data'][i]['id']
															+ "</td><td><img width='30' height='30' src=\"\/smart_community"+data['data']['data'][i]['icon_url']+"\"></td><td>"
															...
															+ "<?php echo U('Admin/Mgrs/edit" + array + "');?>\"><i class=\"fa fa-pencil\"></i>更新</a>"
															+ "<a class=\"btn btn-danger btn-xs\" href=\""
															+ "<?php echo U('Admin/Admin/del_mgrs" + array + "');?>\"><i class=\"fa fa-trash\"></i>删除</a></td>"
															+ "</tr>");
								}
				...
				.one(
						...
						function() {
							$
									.ajax({
										type : "post",
										url : "/smart_community/admin.php/Mgrs/pending_mgrs",
										data : {
											access_token : getCookie('access_token'),
											num : '5',
										},
													...
													$("#tab2")
															.append(
																	"<tr><td>M"
																			...
																			+ "<?php echo U('Admin/Mgrs/detail" + array + "');?>\"><i class=\"fa fa-search-plus\"></i>审批</a>"
																			+ "</td>"
																			+ "</tr>");
												}
												$('#pages2').append(
