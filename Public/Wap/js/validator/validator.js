...
var validator = (function($){
    ...
    */
    message = {
        ...
        checked         : '必须检查',//'must be checked'
        empty           : '不能为空',//'please put something here'
        min             : '输入内容太短',//'input is too short'
        max             : '输入内容太长',//'input is too long'
        number_min      : '数字低于限制',//'too low'
        number_max      : '数字高于限制',//'too high'
        url             : '无效的链接',//'invalid URL'
        number          : '无效数字',//'not a number'
        email           : '无效的邮箱地址',//'email address is invalid'
        email_repeat    : '邮箱地址不匹配',//'emails do not match'
        password_repeat : '密码不匹配',//'passwords do not match'
        repeat          : '不匹配',//'no match'
        complete        : '输入不完整',//'input is not complete'
        select          : '请选择一个选项'//'Please select an option'
    };
